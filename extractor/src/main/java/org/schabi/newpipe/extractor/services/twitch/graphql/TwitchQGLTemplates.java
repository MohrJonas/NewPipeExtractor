...
public final class TwitchQGLTemplates {
    private static final String PLAYBACK_ACCESS_TOKEN_TEMPLATE = "{\"query\": \"{\\n" +
    ...
    {
        return String.format(PLAYBACK_ACCESS_TOKEN_TEMPLATE, channelName);
    }
